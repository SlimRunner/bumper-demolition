  ...
  class Controls_Widget {
      ...
      constructor (component, options = {}) {
          const rules = [".controls-widget * { font-family: monospace }",
                         ...
                         ".controls-widget table.control-box { width: 1080px; border:0; margin:0; transition:.5s; overflow-y:scroll; background:DimGray }",
                         ".controls-widget table.control-box td { overflow:hidden; border:0; background:DimGray; border-radius:30px }",
                         ".controls-widget table.control-box td .control-div { background: #EEEEEE; padding: 5px 5px 5px 30px; box-shadow: 25px 0px 60px -15px inset }",
